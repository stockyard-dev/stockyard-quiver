...
<div class="hdr">
<h1 id="dash-title"><span>&#9670;</span> QUIVER</h1>
...
<script>
var A='/api';
var RESOURCE='reading_items';
var TITLE_FIELD='title';

var fields=[{"name": "id", "label": "Id", "type": "text"}, {"name": "title", "label": "Title", "type": "text"}, {"name": "author", "label": "Author", "type": "text"}, {"name": "url", "label": "Url", "type": "text"}, {"name": "type", "label": "Type", "type": "text"}, {"name": "status", "label": "Status", "type": "text"}, {"name": "rating", "label": "Rating", "type": "integer"}, {"name": "notes", "label": "Notes", "type": "textarea"}, {"name": "tags", "label": "Tags", "type": "text"}, {"name": "completed_at", "label": "Completed At", "type": "text"}, {"name": "created_at", "label": "Created At", "type": "text"}];
